...
public class GoldenCowsClient implements ClientModInitializer {
    ...
    public static final EntityModelLayer MODE_APPLECOW_LAYER = new EntityModelLayer(
    ...
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(MODE_APPLECOW_LAYER, AppleCowEntityModel::getTexturedModelData);
    }
